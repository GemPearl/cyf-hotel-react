    ...
    <Wrapper>
      ...
      {id && (
        ...
        <TouristInfoCard
          ...
          cityName={`${customerInformation.firstName} ${customerInformation.surname}`}
          description={`id: ${customerInformation.id} \b email: ${customerInformation.email} \b phone-Number: ${customerInformation.phoneNumber}`}
          button={false}
